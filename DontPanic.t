...
needs of our customers and the trust they have placed in us.
...
Ask these questions: "What is happening? What is not happening?" Rapidly
begin gathering information and sharing context. Information becomes
intelligence only when it influences the thinking of the leader.
...
Ask yourself: "What can I do to influence the situation?" Interpret the
data you have. Identify threats. Deduce opportunities, alternatives,
...
Relate the outcomes of the decision and action taken to the environment.
Did the system actually change? In the way you expected? Ask yourself and
your team: "If we knew then what we know now, what would we do
differently?"
...
Record everything, with timestamps. As soon as a second person joins you
in responding to the incident, start verbalizing your actions to them and
get them to act as journalist; if you hand over to them, you take the
notes.
